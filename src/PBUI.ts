...
class PBUI {
    ...
    initElements() {
        ...
        this.boundingDiv.innerHTML += this.buildIcon('settings', 'settings-icon', PBConst.EVENTS.requestPassword, "Settings");
        this.boundingDiv.innerHTML += this.buildIcon('help', 'help-icon', PBConst.EVENTS.requestPassword, "Help");
